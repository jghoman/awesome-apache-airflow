...
- [Apache Airflow Monitoring Metrics](https://youtu.be/xyeR_uFhnD4) - A two-part series by (https://maxcotec.com) on how you can utealize existing Airflow statsd metrics to monitor your airflow deployment on Grafana dashboard via Prometheus. Also learn how to create custom metrics.  
- [Introduction to Airflow](https://www.youtube.com/playlist?list=PLzKRcZrsJN_xcKKyKn18K7sWu5TTtdywh) - A web tutorial series by (https://maxcotec.com) for beginners and intermediate users of Apache Airflow.
...
- [Airflow Dag python-package management](https://www.youtube.com/watch?v=9pykChPp-X4&t=121s) - Managing python package dependencies across 100+ dags can become pain. Its hard to keep track of which packages are used by which dag, and hard to cleanup while DAG removal/upgrade. learn how KubernetesPodOperator and DockerOperator and fix this. 
